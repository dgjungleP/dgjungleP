...
- [izachwei/easy-cache](https://github.com/izachwei/easy-cache) ([v1.0.1](https://github.com/izachwei/easy-cache/releases/tag/v1.0.1), 1 day ago) - 支持 Springboot，基于注解的、可扩展的、即开即用通用缓存组件
...
- [niumoo/JavaNotes](https://github.com/niumoo/JavaNotes) - 🧱 「Java学习」一份涵盖大部分Java程序员所需要掌握的核心知识。JDK 源码分析 &amp; Java 新特性 &amp; Java 并发编程 &amp; Java 虚拟机 &amp; SpringBoot 2.x 系列 (5 days ago)
