...
- [veyon/veyon](https://github.com/veyon/veyon) - Cross-platform computer monitoring and classroom management (3 days ago)
- [quasar/Quasar](https://github.com/quasar/Quasar) - Remote Administration Tool for Windows (4 days ago)
- [barry-ran/QtScrcpy](https://github.com/barry-ran/QtScrcpy) - Android real-time display control software (4 days ago)
- [DeviceFarmer/stf](https://github.com/DeviceFarmer/stf) - Control and manage Android devices from your browser. (4 days ago)
- [openstf/stf](https://github.com/openstf/stf) - Control and manage Android devices from your browser. (4 days ago)
