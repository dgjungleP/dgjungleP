...
- [dgjungleP/dou-util-web](https://github.com/dgjungleP/dou-util-web) -  (2 days ago)
...
- [walkor/workerman](https://github.com/walkor/workerman) - An asynchronous event driven PHP socket framework. Supports HTTP, Websocket, SSL and other custom protocols. PHP&gt;=5.3. (2 days ago)
...
- [redox-os/orbtk](https://github.com/redox-os/orbtk) - The Rust UI-Toolkit. (5 days ago)
